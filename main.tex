...
\end{enumerate}
Fig. \ref{fig:tracking-effs} shows each of these tracking efficiencies as a function of track $\pt$ and $\eta$ for both the DBSCAN and union-find clustering approaches. Additionally, Table XX shows the fake rate (non-matched clusters/all clusters) across the full $\pt$ and $\eta$ range. 
...
\begin{table}[]
    \centering
    \begin{tabular}{efficiency | union-find | DBSCAN}
         &  & \\
         &  &
    \end{tabular}
    \caption{Caption}
...
% Add fake rate as well as efficiency
