...
\begin{abstract}
  ...
  In this work, we adapt the physics-motivated interaction network (IN) GNN to the problem of particle tracking in the high-pileup conditions expected at the High-Luminosity Large Hadron Collider.
  We demonstrate the IN's excellent edge-classification accuracy and tracking efficiency through a suite of measurements at each stage of GNN-based tracking: graph construction, edge classification, and track building. 
  ...
  Furthermore, the IN may be represented as either a set of explicit matrix operations or a message passing GNN. Efforts are underway to accelerate each representation via heterogeneous computing resources towards both high-level and low-latency triggering applications. 
...
1.0  & $45501 \pm 5057$ &  $2233\pm 333$ & $5315\pm152 $ & $0.094\pm0.010$ \\ 
0.9  & $43839 \pm 4855$ &  $2735\pm 395$ & $6475\pm151 $ & $0.114\pm0.012$ \\ 
0.8  & $41677 \pm 4583$ &  $3396\pm 480$ & $7976\pm150 $ & $0.141\pm0.015$ \\ 
0.7  & $38778 \pm 4242$ &  $4278\pm 582$ & $9993\pm148 $ & $0.176\pm0.019$ \\ 
0.6  & $34951 \pm 3798$ &  $5448\pm 714$ & $12650\pm146 $ & $0.223\pm0.024$ \\ 
0.5  & $29830 \pm 3265$ &  $7025\pm 875$ & $16194\pm144 $ & $0.285\pm0.031$ \\
\end{tabular}
\end{table*}
...
In the track building step, the predicted edge weights $w_k\in W(\mathcal{G}_{COO})$ are used to infer that edges satisfying $w_k\geq\delta^*$ represent true track segments. 
If the edge weight mask perfectly reproduced the training target (i.e. $\mathtt{int}(W(\mathcal{G}_{COO})\geq\delta^*)=y$), the edge-classification step would produce $n_\mathrm{particles}$ disjoint subgraphs, each corresponding to a single particle. 
...
\todo{Add rough summary of numbers (like a range).}
In general, though, higher purity does not necessarily improve downstream physics performance. % In fact, we tend to see the opposite.
\todo{Modify sentence above.}
